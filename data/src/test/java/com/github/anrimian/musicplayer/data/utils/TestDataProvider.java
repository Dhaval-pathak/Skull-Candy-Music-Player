...
public class TestDataProvider {
    ...
    public static StorageComposition fakeStorageComposition(long id, String title, String parentPath) {
        return new StorageLocalCompositionBuilder(id, id, title).parentPath(parentPath).build();
    }
    ...
    public static class StorageLocalCompositionBuilder {
        ...
        public StorageLocalCompositionBuilder parentPath(String filePath) {
